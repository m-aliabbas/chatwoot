...
const {
  ...
  CHANGELOG_POST_URL_TEMPLATE: changelogPostUrlTemplate,
  ...
  HELP_CENTER_CNAME_TARGET: helpCenterCnameTarget,
  INSTALLATION_NAME: installationName,
  LOGO_THUMBNAIL: logoThumbnail,
  LOGO: logo,
  LOGO_DARK: logoDark,
  PRIVACY_URL: privacyURL,
  SUPPORT_DOCS_URL: supportDocsURL,
